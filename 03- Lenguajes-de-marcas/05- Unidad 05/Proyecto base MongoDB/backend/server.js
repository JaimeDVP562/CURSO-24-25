...
const nombre_BD = "BD_usuarios"; // Nombre de la base de datos que nos conectamos
...
app.get("/usuario", async (req, res) => {
    try {
        ...
        if (req.query.nombre) {
            filtro.nombre = { $regex: req.query.nombre, $options: "i" }; // Búsqueda insensible a
            mayúsculas / minúsculas
        }
        // Si hay un parámetro "email" en la URL, lo usamos como filtro con búsqueda flexible
