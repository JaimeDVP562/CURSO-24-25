...
import examen.clases.Pelicula;
import examen.clases.Videoclub;

/**
 * Programación curso 2024|25 Antonio J.Sánchez Bujaldón
 * 
 * Clase de prueba para la TAREA 3: Implementación del Catálogo genérico
 */
...
public class PruebaTarea3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // ###################################################
            // Sólo podrá comprobar que funciona si las películas aparecen en orden
            // alfabético:
        ...
        // ##################################################################################
        System.out.println("\n=== RESULTADO TAREA 3 ===");
        System.out.println(allTestsPassed ? "✅ Todos los requisitos implementados correctamente"
