...
public class MainEj05TiendaDiscos {
    public static void main(String[] args) throws Exception {
        ...
        // Discos iniciales
        tiendaDiscos.añadir(new Disco("001","Pink Floyd","The Wall","Rock sinfónico",180));tiendaDiscos.añadir(new Disco("002","Guns N' Roses","Appetite for Destruction","Heavy Metal",70));tiendaDiscos.añadir(new Disco("003","Dire Straits","Brothers in arms","Rock",80));
        ...
        try{switch(opcion){case 1->listarDiscos(tiendaDiscos,sc);case 2->nuevoDisco(tiendaDiscos,sc);case 3->modificarDisco(tiendaDiscos,sc);case 4->borrarDisco(tiendaDiscos,sc);}}catch(Exception e){System.out.println("Se ha producido un error: "+e.toString());}System.out.println("\n");
