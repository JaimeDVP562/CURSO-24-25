...
public class Main {
        public static void main(String[] args) {
                ...
                System.out.printf("Función esMayor    : %s\n",
                                MatLib.esMayor(5, 4) && !MatLib.esMayor(4, 5) && !MatLib.esMayor(5, 5) ? "correcto"
                                                : "falso");
                System.out.printf("Función esMenor    : %s\n",
                                MatLib.esMenor(4, 5) && !MatLib.esMenor(5, 4) && !MatLib.esMenor(5, 5) ? "correcto"
                                                : "falso");
                ...
                System.out.printf("Funci ón resto      : %s\n",
